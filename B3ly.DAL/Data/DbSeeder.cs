    ...
    public static class DbSeeder
    {
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            if (!await db.Categories.AnyAsync())
            {
                ...
                db.Categories.AddRange(electronics, phones, laptops, clothing, books);
                ...
                db.Products.AddRange(
                    ...
                    new Product { CategoryId = clothing.CategoryId,   Name = "Classic White T-Shirt",SKU = "CLT-MWT",    Price = 29.99m,   StockQuantity = 100, Description = "Premium cotton white t-shirt.",                   ImageUrl = "https://placehold.co/400x400?text=White+Tshirt" },
                    new Product { CategoryId = clothing.CategoryId,   Name = "Slim Fit Jeans",       SKU = "CLT-MJN",    Price = 59.99m,   StockQuantity = 75,  Description = "Slim fit blue denim jeans.",                     ImageUrl = "https://placehold.co/400x400?text=Slim+Jeans" },
                    new Product { CategoryId = clothing.CategoryId,   Name = "Floral Summer Dress",  SKU = "CLT-WFD",    Price = 49.99m,   StockQuantity = 60,  Description = "Beautiful floral pattern summer dress.",          ImageUrl = "https://placehold.co/400x400?text=Floral+Dress" },
